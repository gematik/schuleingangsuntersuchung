---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/GewichtGeburtNormal
expand: 1
---
...
from
	StructureDefinition
where
	url = 'https://www.oegd.de/fhir/seu/StructureDefinition/GewichtGeburtNormal'
select
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/GewichtGeburtNormal' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
<tabs>
    <tab title="Übersicht">      
        {{render:GewichtGeburtNormalBeispiel}}
    </tab>
    <tab title="XML">      
        {{xml:GewichtGeburtNormalBeispiel}}
    </tab>
    <tab title="JSON">
        {{json:GewichtGeburtNormalBeispiel}}
    </tab>
    <tab title="Link">
        {{link:GewichtGeburtNormalBeispiel}}
    </tab>
</tabs>