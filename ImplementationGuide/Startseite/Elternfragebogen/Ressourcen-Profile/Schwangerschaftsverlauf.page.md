---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Schwangerschaftsverlauf
expand: 1
---
...
from
	StructureDefinition
where
	url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Schwangerschaftsverlauf'
select
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Schwangerschaftsverlauf' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
<tabs>
    ...
    <tab title="Link">
        {{link:SchwangerschaftsverlaufBeispiel}}
    </tab>
</tabs>