---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Arzt
expand: 1
---
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Arzt' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
from
	CapabilityStatement
where rest.resource.type = 'Practitioner' 
