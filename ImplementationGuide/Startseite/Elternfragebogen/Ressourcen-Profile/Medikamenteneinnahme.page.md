---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Medikamenteneinnahme
expand: 1
---
...
from
	StructureDefinition
where
	url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Medikamenteneinnahme'
select
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Medikamenteneinnahme' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
<tabs>
    ...
    <tab title="Link">
        {{link:MedikamenteneinnahmeBeispiel}}
    </tab>
</tabs>