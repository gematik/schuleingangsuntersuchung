---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Krankenhausaufenthalt
expand: 1
---
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Krankenhausaufenthalt' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
<tabs>
    ...
    <tab title="Link">
        {{link:KrankenhausaufenthaltBeispiel}}
    </tab>
</tabs>