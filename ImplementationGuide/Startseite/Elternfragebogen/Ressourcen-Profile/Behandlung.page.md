---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Behandlung
expand: 1
---
...
from
	StructureDefinition
where
	url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Behandlung'
select
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Behandlung' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
<tabs>
    <tab title="Übersicht">      
        {{render:BehandlungBeispiel}}
    </tab>
    <tab title="XML">      
        {{xml:BehandlungBeispiel}}
    </tab>
    <tab title="JSON">
        {{json:BehandlungBeispiel}}
    </tab>
    <tab title="Link">
        {{link:BehandlungBeispiel}}
    </tab>
</tabs>