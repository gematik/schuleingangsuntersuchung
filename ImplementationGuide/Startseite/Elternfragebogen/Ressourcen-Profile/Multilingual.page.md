---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Multilingual
expand: 1
---
...
from
	StructureDefinition
where
	url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Multilingual'
select
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Multilingual' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
