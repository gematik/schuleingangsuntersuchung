---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/VerwandtePersonDeutschkenntnis
expand: 1
---
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/VerwandtePersonDeutschkenntnis' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
...
<tabs>
    ...
    <tab title="Link">
        {{link:VerwandtePersonDeutschkenntnisBeispiel}}
    </tab>
</tabs>