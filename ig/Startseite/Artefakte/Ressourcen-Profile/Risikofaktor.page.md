---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Risikofaktor
expand: 1
---
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Risikofaktor' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
