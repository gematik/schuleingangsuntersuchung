---
subject: https://www.oegd.de/fhir/seu/StructureDefinition/Schulempfehlung
expand: 1
---
...
from
	StructureDefinition
where
	url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Schulempfehlung'
select
...
@``` 
from StructureDefinition where url = 'https://www.oegd.de/fhir/seu/StructureDefinition/Schulempfehlung' for differential.element.constraint select Name: key, Schweregrad: severity, Beschreibung: human, Ausdruck: expression
```
